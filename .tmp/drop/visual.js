var helloWorldA826EAF062B1485CAE353E3F4DE7BC64_DEBUG;
/******/ (() => { // webpackBootstrap
...
/* harmony import */ var google_charts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5073);
...
class Visual {
    ...
    update(options) {
        ...
        var track = 0;
        tableDataView.rows.forEach((row, index) => {
    ...
    durationFilter(val) {
        if (val >= 60) {
            let duration = moment__WEBPACK_IMPORTED_MODULE_0__.duration(val, "seconds");
    ...
    createChart(id, value) {
        google_charts__WEBPACK_IMPORTED_MODULE_1__/* .GoogleCharts.load */ .E.load(() => {
            // Define the chart to be drawn.
            var data = new google_charts__WEBPACK_IMPORTED_MODULE_1__/* .GoogleCharts.api.visualization.DataTable */ .E.api.visualization.DataTable();
            ...
            const chart = new google_charts__WEBPACK_IMPORTED_MODULE_1__/* .GoogleCharts.api.visualization.PieChart */ .E.api.visualization.PieChart(document.getElementById('myChart' + id));
    ...
    callupdate() {
        const selectElement = document.getElementById("responseTime");
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "E": () => (/* binding */ GoogleCharts)
/* harmony export */ });
...
/* unused harmony default export */ var __WEBPACK_DEFAULT_EXPORT__ = ((/* unused pure expression or super */ null && (GoogleChartsManager)));
...
/* harmony export */ });
/* harmony import */ var _src_visual__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8867);
/* provided dependency */ var window = __webpack_require__(6738);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (helloWorldA826EAF062B1485CAE353E3F4DE7BC64_DEBUG);

})();

helloWorldA826EAF062B1485CAE353E3F4DE7BC64_DEBUG = __webpack_exports__;
/******/ })()
;
